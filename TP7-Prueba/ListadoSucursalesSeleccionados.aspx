<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListadoSucursalesSeleccionados.aspx.cs" Inherits="TP7_Prueba.ListadoSucursalesSeleccionado" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <br /><br />
            <asp:Label ID="lblMostrar" runat="server" Text="Mostrar sucursales seleccionadas" Font-Bold="True" Font-Size="XX-Large"></asp:Label>
            <br /><br />
